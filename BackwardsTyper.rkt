...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname BackwardsTyper) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (editor-render ed)
  (overlay/align "left" "center"
               (beside
                 (text (implode (editor-pre ed)) 15 "black")
